...
public class CriterioMenorPrecioTest {
	...
	private Presupuesto unPresupuesto = new Presupuesto(null, null, 1, unosDetalles, null);
	private Presupuesto otroPresupuesto = new Presupuesto(null, null, 2, otrosDetalles, null);
